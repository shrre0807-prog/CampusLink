...
export const SAMPLE_STUDENTS: StudentProfile[] = [
  {
    id: "STU_2026_8832",
    name: "Arjun Kumar",
    email: "arjun.kumar@annauniv.edu",
    ...
    cgpa: 8.92,
    graduationYear: 2026,
    apaarId: "9928-1123-4451",
    digiLockerVerified: true,
    abcCredits: 142,
    vciScore: 84,
    githubUsername: "arjun-k-dev",
    githubScore: 82,
    linkedinUrl: "https://linkedin.com/in/arjun-kumar-dev",
    portfolioUrl: "https://arjun-kumar.dev",
    leetcodeUsername: "arjun_codes",
    bio: "Final-year CSE undergraduate specializing in distributed systems, asynchronous event-driven architectures, and high-concurrency backend services in Python & TypeScript.",
    resumeFileName: "Arjun_Kumar_Resume_2026.pdf",
    resumeUploadDate: "2026-08-20",
    resumeSizeKb: 184,
    resumeRawText: `ARJUN KUMAR | arjun.kumar@annauniv.edu | +91 98401 23456 | Chennai, India
EDUCATION: Anna University, Chennai — B.Tech Computer Science (2022-2026) | CGPA: 8.92/10
SKILLS: Python, FastAPI, Node.js, TypeScript, PostgreSQL, pgvector, Docker, Kafka, Redis, React
PROJECTS:
1. Distributed Task Scheduler: Event-driven worker pool with Redis & Kafka handling 15k events/sec.
2. Vector Search Engine: Semantic document retrieval using pgvector, HNSW indexing & FastAPI.
3. Micro-Services Gateway: Rate-limited authentication & reverse proxy with Prometheus metrics.
EXPERIENCE: Backend Developer Intern at Fintech Labs (May-Jul 2025).`,
    projects: [
      {
        id: "proj_01",
        title: "Distributed Task Scheduler & Worker Engine",
        description: "Built high-throughput worker pool using Kafka consumer groups, dead-letter queues, and Redis locking to handle 15,000 tasks/second.",
        techStack: ["Python", "FastAPI", "Apache Kafka", "Redis", "Docker"],
        githubUrl: "https://github.com/arjun-k-dev/distributed-scheduler",
        liveUrl: "https://scheduler-demo.arjun-kumar.dev",
      },
      {
        id: "proj_02",
        title: "Vector Search & Retrieval Pipeline",
        description: "Zero-latency semantic code search engine utilizing pgvector HNSW embeddings and Tree-sitter AST syntax chunking.",
        techStack: ["TypeScript", "PostgreSQL", "pgvector", "Docker"],
        githubUrl: "https://github.com/arjun-k-dev/vector-ast-search",
      },
    ],
    sandboxCompletionRate: 91,
    skills: [
      {
        name: "Python (AsyncIO / FastAPI)",
        category: "Backend",
      ...
      },
      {
        ...
        testCoverageRatio: 0.74,
      },
      {
        name: "Apache Kafka & Event Queues",
        category: "Distributed Systems",
        claimedConfidence: 80,
        verifiedConfidence: 45,
    ...
    remediationRoadmap: [
      {
        id: "REM_01",
        title: "Build Distributed Event Consumer with Kafka Lag Handling",
        skillTarget: "Apache Kafka / Message Queues",
        sourceDeficit: "Recruiter Rejection Telemetry: Round 2 System Design Failure",
        recruiterFeedbackSource: "Razorpay Technical Round: Lacks hands-on event partition & dead-letter queue recovery",
        estimatedMinutes: 45,
        difficulty: "Intermediate",
        completed: false,
        ncrfMicroCredits: 0.5,
        starterCode: `// Task: Implement an idempotent Kafka event consumer with exponential backoff retry\nasync function processEvent(event: KafkaEvent, retryCount = 0) {\n  // TODO: Fix race condition and commit offset only upon successful processing\n}`,
      },
      {
        id: "REM_02",
        title: "Kubernetes Multi-Stage Health Probes & Resource Limits",
        skillTarget: "Kubernetes Orchestration",
        sourceDeficit: "University Curriculum Deficit: AICTE Level 5 Modern Infrastructure",
        estimatedMinutes: 30,
        difficulty: "Intermediate",
        completed: true,
        ncrfMicroCredits: 0.5,
      ...
      {
        id: "REM_03",
        title: "Async Task Worker Concurrency & Memory Leak Prevention",
        skillTarget: "Concurrency & Event Loops",
        sourceDeficit: "WASM Sandbox Diagnostic Flag",
        estimatedMinutes: 20,
        difficulty: "Advanced",
        completed: false,
        ncrfMicroCredits: 0.5,
    ...
    recentApplications: [
      {
        ...
        status: "Rejected_Round2",
        vciMatchScore: 82,
        recruiterFeedback: {
          primaryFailureReason: "Distributed Systems & Message Queue Partitioning",
          toolingDeficit: "Kafka consumer group rebalancing & dead-lettering",
          softSkillRating: 4,
      ...
      },
      {
        jobId: "JOB_9012",
        company: "Zerodha",
        role: "Full-Stack Infrastructure Intern",
    ...
    astStats: {
      ...
      entropyScore: 0.84,
      topLanguages: [
        { language: "TypeScript / JS", percentage: 48 },
        { language: "Python", percentage: 34 },
        { language: "SQL", percentage: 12 },
        { language: "Shell / Dockerfile", percentage: 6 },
      ],
    },
  },
  {
